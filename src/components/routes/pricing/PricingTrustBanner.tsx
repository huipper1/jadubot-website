...
export function PricingTrustBanner() {
  return (
    <section className="relative py-10 md:py-14 border-t border-border/60 bg-background">
      <div className="container mx-auto max-w-7xl px-4">
        <PopIn className="space-y-10">
          {/* Payment Methods Section */}
          <div className="rounded-2xl border border-border bg-card/80 p-6 sm:p-8 backdrop-blur-md">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 text-center lg:text-left">
              <div>
                ...
                <h3 className="mt-2 font-heading text-lg font-bold text-foreground sm:text-xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {/* 7-Day Guarantee */}
            <div className="relative rounded-2xl border border-emerald-500/20 bg-card/70 p-6 backdrop-blur-md">
            ...
            <div className="relative rounded-2xl border border-[#0172ff]/25 bg-card/70 p-6 backdrop-blur-md">
            ...
            <div className="relative rounded-2xl border border-border bg-card/70 p-6 backdrop-blur-md sm:col-span-2 lg:col-span-1">
