      ...
      {submitted ? (
        <div className="py-12 text-center animate-in fade-in-50">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center justify-center rounded-xl border border-border bg-white/[0.06] px-5 py-2.5 text-xs font-semibold text-foreground transition hover:bg-muted"
          >
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between">
              <label htmlFor="contact-phone" className="block text-xs font-medium text-foreground">
          ...
          {/* Topic / Solution */}
          <div>
            <label htmlFor="contact-topic" className="block text-xs font-medium text-foreground">
          ...
          {/* Monthly Volume */}
          <div>
            <label htmlFor="contact-volume" className="block text-xs font-medium text-foreground">
