    ...
    <section className="relative py-16 sm:py-20 md:py-24 border-t border-white/[0.08]">
      <div className="container mx-auto max-w-5xl px-4 sm:px-6">
        <PopIn className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-2 font-heading text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight">
            Still Have Questions? Talk to Our Engineers
          </h2>
          <p className="mt-2 text-sm sm:text-base text-slate-300 leading-relaxed max-w-xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <PopIn delay={0.05} className="flex">
            <div className="group relative flex flex-col justify-between w-full rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-[#0c1815] to-[#0a1210] p-6 shadow-xl transition-all duration-300 hover:border-emerald-500/45 hover:shadow-[0_0_24px_rgba(16,185,129,0.15)]">
              <div>
          ...
          <PopIn delay={0.1} className="flex">
            <div className="group relative flex flex-col justify-between w-full rounded-2xl border border-white/10 bg-[#0c1017]/80 p-6 shadow-xl backdrop-blur-md transition-all duration-300 hover:border-white/20">
              <div>
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/[0.06] text-slate-300">
              ...
              <a
                ...
                className="mt-6 inline-flex w-full items-center justify-center gap-1.5 rounded-xl border border-white/10 bg-white/[0.05] px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-white/10"
              >
          ...
          <PopIn delay={0.15} className="flex">
            <div className="group relative flex flex-col justify-between w-full rounded-2xl border border-[#0172ff]/25 bg-gradient-to-br from-[#0b1424] to-[#090d16] p-6 shadow-xl transition-all duration-300 hover:border-[#0172ff]/45 hover:shadow-[0_0_24px_rgba(1,114,255,0.2)]">
              <div>
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#0172ff]/15 text-sky-400">
        ...
        {/* Reassurance Footer */}
        <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-400 border-t border-white/[0.05] pt-6 text-center">
