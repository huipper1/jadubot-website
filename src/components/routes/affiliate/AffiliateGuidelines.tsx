    ...
    <section className="relative py-16 sm:py-20 md:py-24 border-t border-border">
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        <PopIn className="mx-auto max-w-3xl text-center mb-14">
          ...
          <p className="font-bengali mt-3 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 md:divide-x md:divide-border">
          {/* Col 1: Payout Rules */}
          <PopIn delay={0.05} className="space-y-6">
            <div className="flex items-center gap-2.5 pb-3 border-b border-border">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground font-bengali">
            ...
            <div className="space-y-5 font-bengali">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">ইনস্ট্যান্ট ব্যালেন্স ক্রেডিট</h4>
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">মিনিমাম ব্যালেন্স ৳২,০০০</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">মাসে ২ বার নিশ্চিত পেমেন্ট সাইকেল</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">বিকাশ, নগদ ও ব্যাংক একাউন্ট</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
          ...
          <PopIn delay={0.1} className="space-y-6 md:pl-16">
            ...
            <div className="space-y-5 font-bengali">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">সঠিক ও অনুমোদিত তথ্য পরিবেশন</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-sky-400 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">অযাচিত স্প্যামিং নিষিদ্ধ</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-sky-400 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">ভুয়া অফিসিয়াল পেজ নিষিদ্ধ</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                <span className="h-1.5 w-1.5 rounded-full bg-sky-400 mt-2 shrink-0" />
                <div>
                  <h4 className="text-sm sm:text-base font-bold text-foreground">অফিসিয়াল পার্টনার কমিউনিটি</h4>
                  <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">
