    ...
    <section className="relative pt-32 pb-12 sm:pt-36 sm:pb-16 md:pt-40 md:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl px-4 sm:px-6">
        <PopIn className="space-y-6 text-center sm:text-left">
          ...
          <p className="font-bengali max-w-3xl text-lg sm:text-xl text-slate-300 leading-relaxed font-normal">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-2 text-xs sm:text-sm text-sky-200">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center sm:justify-start gap-4">
            ...
            <a
              href="#calculator"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-6 py-3.5 text-sm sm:text-base font-medium text-slate-200 transition hover:bg-white/10 hover:border-white/20"
            >
          ...
          <div className="mt-12 pt-8 border-t border-white/[0.08] grid grid-cols-2 md:grid-cols-4 gap-6 text-left">
            <div>
              <div className="font-mono text-2xl sm:text-3xl font-extrabold text-white">
                ২০%
              </div>
              <div className="mt-1 text-xs text-slate-400 font-bengali">
            ...
            <div className="border-t border-white/[0.08] pt-4 md:border-t-0 md:pt-0 md:border-l md:pl-6">
              <div className="font-mono text-2xl sm:text-3xl font-extrabold text-white">
                মাসে ২ বার
              </div>
              <div className="mt-1 text-xs text-slate-400 font-bengali">
